...
var sketch = function( p ) { 
  ...
  p.setup = function() {
    ...
    reset_button = p.createButton('clear drawing [C]');
    reset_button.position(10, screen_height-27-27);
    reset_button.mousePressed(reset_button_event);

    save_button = p.createButton('save drawing [S]');
    save_button.position(125, screen_height-27-27);
    save_button.mousePressed(save_button_event);
  ...
  p.draw = function() {
    if (p.mouseY < screen_height-27-27) {
